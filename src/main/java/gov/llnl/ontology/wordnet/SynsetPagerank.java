...
public class SynsetPagerank {
    ...
    public static void setTransitionAttribute(Synset synset,
        ...
        for (Synset related : synset.getRelations(Synset.Relation.HYPERNYM)) //.allRelations())	// TODO: consider using only some relations
    ...
    public static void setupTransitionAttributesLimited(
            ...
            Map<Synset, Integer> synsetMap,
            int startIndex) {
        for (int i = startIndex; i< synsetList.size(); i++) {
    ...
    public static SparseDoubleVector computePageRank(
        ...
        for (int i = 0; i < iterations; ++i) {
            ...
            */
            ...
            /* Deprecated due to the low number of iterations
            double delta = 0;
